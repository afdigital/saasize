...
feature "Accounts" do
  scenario "creating an account" do
    visit saasize.root_path
    click_link "Account Sign Up"
    fill_in "Name", :with => "Test"
    fill_in "Subdomain", :with => "test"
    fill_in "Email", :with => "saasize@example.com"
    ...
    expect(page).to have_content("Signed in as saasize@example.com")
    expect(page.current_url).to eq("http://test.example.com/")
  end

  scenario "Ensure subdomain uniqueness" do
    Saasize::Account.create!(:subdomain => "test", :name => "Test")
